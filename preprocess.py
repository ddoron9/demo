...
class AudioData:
    ...
    def get_audio(self,PATH):
        ...
        return TensorDataset(stacked_mel,self.data)

PATH = '/opt/utopsoft/label-management/webapps/attach/label'
transformed_train_data = AudioData(PATH,48000)

torch.save(transformed_train_data,'./train_data.pt')